...
function read_ta_network(network_path,network_name)
#  tntp_dir = download_tntp()
  tntp_dir = "/home/juergen/"
  network_dir = joinpath(network_path, network_name)
...
function load_ta_network(network_path,network_name; best_objective=-1.0, toll_factor=0.0, distance_factor=0.0)
  network_data_file, trip_table_file = read_ta_network(network_path,network_name)
